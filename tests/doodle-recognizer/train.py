...
num_classes = len(txt_name_list) # set number of different classes to identify to number of different class-files in folder
...
cnn.save('model_image.h5')  # creates  HDF5 file
