...
class Sandbox(Page):
    ...
    def draw(self: any) -> None:
        ...
        self.canvas.draw((title_padding, canvas_y),
                         (canvas_size, canvas_size), Colors.white)
        self.text_input.draw((title_padding + canvas_size * 0.5, canvas_y + canvas_size * 0.875 +
                             title_padding / 2), canvas_size * 0.5 - title_padding, (title_padding / 2, title_padding / 2), 10)
        ...
        if hasattr(self, 'result'):
            ...
            max_width = 0
            display_count = 5
            total = sum([guess['certainty']
                        for guess in self.result[:display_count]])
            ...
            for i in range(display_count):
                ...
                text = self.game.text_surface(
                    string, 'Arial', font_size, Colors.black)
            ...
            width = self.game.dim[0] - (canvas_size + 2 *
                                        title_padding) - max_width - 2 * title_padding
